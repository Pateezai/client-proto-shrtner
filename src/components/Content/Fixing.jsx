...
const Fixing = () => {
  ...
  const handlenewcustom = (e, key) => {
    const newCustomize = [...newcustom];
    newCustomize[key] = e.target.value;
    setNewcustom(newCustomize);
  };

  //////////////////////////////////////INPUT VALUE////////////////////////////////////
  const handlebuttonedit = (id, key) => {
    const newEdit = [...edit];
    newEdit[key] = true;
    setEdit(newEdit);
    setCheckedit((prevCheckedit) => ({
        ...prevCheckedit,
        [key]:true,
    }))
  }
...
//   };
  ...
  const handleUpdate = async (id, key) => {
    ...
    try {
      ...
      setNewcustom((prevCustom) => {
        const updatedCustoms = [...prevCustom];
        updatedCustoms[key] = "";
    ...
    <>
      <div className="fixing">
        <Container>
          ...
          {showres && (<Row className="d-flex justify-content-center my-5">
            <Col>
              <Card border="success">
                <Card.Header className="text-center">
                      ...
                      return (
                        <tr key={key}>
                          ...
                          <td className="col-2">
                            <Form.Control
                             disabled={!edit[key]}
                              ...
                              // name="customupdate"
                              //  id={`customupdate-${key}`}
                              //  name={`customupdate-${key}`}
                              placeholder={val.custom}
                              value={newcustom[key]}
                              onChange={(e) => {
                                handlenewcustom(e, key);
                              }}
                            />
                          </td>
                          ...
                          <td className="col d-flex gap-1 justify-content-center">
                           {checkedit[key] ?( <Button
                              variant="success"
                              onClick={() => {
                                handleUpdate(val._id, key);
                              }}
                            >
                              Save
                            </Button>)
